...
export const TokenCard = ({ token, price }: TokenCardProps) => {
    return (
        <motion.div
            ...
            className={`
                w-full h-full cursor-pointer rounded-xl 
            ...
            <div className="flex justify-between items-center p-3">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-foreground-500">{token.symbol} · {price ?? 0}$</div>
                    </div>
                </div>
