            ...
            <KaniCardBody>
                <div className="flex items-center justify-between">
                    ...
                    <KaniLink 
                        ...
                        onPress={() => {
                            const filteredLiquidityPoolIds = formik.values.liquidityPoolIds?.filter(
                                (displayId: string) => displayId !== liquidityPool.displayId
                            ) ?? []
                            formik.setFieldValue("liquidityPoolIds", filteredLiquidityPoolIds)
                        }}>
                        <XIcon/>
                    </KaniLink>
                </div>
